                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div class="text-inform">
                                <h3 class="text">Recensement Suicide</h3>
                                <p class="text1"> Bienvenue Sur Ce Site Qui Vous Permettra De Recenser Tous Les Suicides</p>
                            </div>
                            <form action="connect_succide.php" method="POST">
                                <div class="first">
                                    <div class="titre">
                                        <fieldset>
                                            <legend>Titre</legend>
                                ...
                                <div class="place">
                                    <div class="engin">
                                        <fieldset>
                                            <legend>type de suicide</legend>
                                            <select name="typesuicide" id="typesuicide">
                                                <option value=""></option>
                                                <?php foreach ($a as $typesuicides) : ?>
                                                    <option value="<?= $typesuicides->id ?>"><?= $typesuicides->typesuicides ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </fieldset>
                                    </div>
