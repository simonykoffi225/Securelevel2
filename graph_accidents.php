                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div style="text-align:center; margin-top: 40px;">
                                <h3>Recensement Graph Accident</h3>
                                <p style="font-weight:bold; font-size: 15px;"> Se Graphe Nous Permet De Voir <br> Les Statistiques Des Différents Accidents Dans Les Régions De La CI</p>
                            </div>
                            <form action="graph_accidents.php" method="GET">
                                <div class="chartCard">
                                    <div class="chartBox">
                                ...
                                <section class="barderecherche">
                                    ...
                                    <div class="barderecherche1">
                                        <select name="annee">
                                            ...
                                            <option <?= (isset($_GET["annee"]) && $_GET["annee"] == "2017") ? "selected" : ""; ?> value="2017">2017</option>
                                            <option <?= (isset($_GET["annee"]) && $_GET["annee"] == "2016") ? "selected" : ""; ?> value="2016">2016</option>
                                            <option <?= (isset($_GET["annee"]) && $_GET["annee"] == "2015") ? "selected" : ""; ?> value="2015">2015</option>
                                            <option <?= (isset($_GET["annee"]) && $_GET["annee"] == "2014") ? "selected" : ""; ?> value="2014">2014</option>
                                            <option <?= (isset($_GET["annee"]) && $_GET["annee"] == "2013") ? "selected" : ""; ?> value="2013">2013</option>
                                        </select>
                                    </div>
