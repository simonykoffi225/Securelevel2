                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div class="text-inform">
                                <h3 class="text">Recensement Incendie</h3>
                                <p class="text1"> Bienvenue Sur Ce Site Qui Vous Permettra De Recenser Tous Les Incendies</p>
                            </div>
                            <form action="connect_incendies.php" method="POST">
                                <div class="first">
                                    <div class="titre">
                                        <fieldset>
                                            <legend>Titre</legend>
                                ...
                                <div class="place">
                                    <div class="engin">
                                        <fieldset>
                                            ...
                                            <select name="typeIncendie" id="typeIncendie">
                                                <option value=""></option>
                                                <?php foreach ($accid as $typeincendies) : ?>
                                                    <option value="<?= $typeincendies->id ?>"><?= $typeincendies->typeincendies ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </fieldset>
                                    </div>
