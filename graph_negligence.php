...
if (isset($recherche)) {
    if (($lieu != 0) && ($annee != 0)) {
        for ($mois = 1; $mois <= 12; $mois++) {
            $info = $db->prepare("SELECT COUNT(*) AS nbAccident FROM negligences_medicales INNER JOIN ville ON lieu = id WHERE MONTH(dateEvenement) = $mois AND (lieu =$lieu) OR (YEAR(dateEvenement) = $annee)");
            $info->execute();
                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div style="text-align:center; margin-top: 40px;">
                                <h3>Recensement Graph Negligence Medicale</h3>
                                <p style="font-weight:bold; font-size: 15px;"> Se Graphe Nous Permet De Voir <br> Les Statistiques Des Différents Négligence Médical Dans Les Régions De La CI</p>
                            </div>
                            <form action="graph_negligence.php" method="GET">
                                <div class="chartCard">
                                    <div class="chartBox">
                                ...
                                <?php include("datas_negligence.php"); ?>
                                ...
                                <script>
                                    ...
                                    const data = {
                                        ...
                                        datasets: [{
                                            label: 'Nombre de negligence medical / Mois',
                                            data: [
                                                <?php echo $total_jan; ?>,
                                                <?php echo $total_feb; ?>,
                                                <?php echo $total_mar; ?>,
