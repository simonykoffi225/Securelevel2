...
if (isset($recherche)) {
    if (($lieu != 0) && ($annee != 0)) {
        for ($mois = 1; $mois <= 12; $mois++) {
            @$info = $db->prepare("SELECT COUNT(*) AS nbAccident FROM innondations INNER JOIN ville ON lieu = id WHERE MONTH(dateEvenement) = $mois AND (lieu =$lieu) OR (YEAR(dateEvenement) = $annee)");
            @$info->execute();
...
<body>
    <!-- <div class="lien">
        <a href="innondation.php">Innondation</a>
    </div> -->
    <div class="principal">
                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div style="text-align:center; margin-top: 40px;">
                                <h3>Recensement Graph Innondation</h3>
                                <p style="font-weight:bold; font-size: 15px;"> Se Graphe Nous Permet De Voir <br> Les Statistiques Des Différents Innondation Dans Les Régions De La CI</p>
                            </div>
                            <form action="innondation.php" method="GET">
                                <div class="chartCard">
                                    <div class="chartBox">
                                ...
                                <?php include("datas_innondation.php"); ?>
                                ...
                                <script>
                                    ...
                                    const data = {
                                        ...
                                        datasets: [{
                                            label: 'Nombre d\'innondation / Mois',
                                            data: [
                                                <?php echo $total_jan; ?>,
                                                <?php echo $total_feb; ?>,
                                                <?php echo $total_mar; ?>,
