                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div class="text-inform">
                                <h3 class="text">Recensement Meurtre</h3>
                                <p class="text1"> Bienvenue Sur Ce Site Qui Vous Permettra De Recenser Tous Les Meurtre</p>
                            </div>
                            <form action="connect_meurtre.php" method="POST">
                                <div class="first">
                                    <div class="titre">
                                        <fieldset>
                                            <legend>Titre</legend>
                                ...
                                <div class="place">
                                    <div class="engin">
                                        <fieldset>
                                            <legend>type de meurtre</legend>
                                            <select name="typemeurtre" id="typemeurtre">
                                                <option value=""></option>
                                                <?php foreach ($ac as $typemeurtres) : ?>
                                                    <option value="<?= $typemeurtres->id ?>"><?= $typemeurtres->typemeurtres ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </fieldset>
                                    </div>
