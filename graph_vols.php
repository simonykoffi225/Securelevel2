                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div style="text-align:center; margin-top: 40px;">
                                <h3>Recensement Graph Vols</h3>
                                <p style="font-weight:bold; font-size: 15px;"> Se Graphe Nous Permet De Voir <br> Les Statistiques Des Différents Vols Dans Les Régions De La CI </p>
                            </div>
                            <form action="graph_vols.php" method="GET">
                                <div class="chartCard">
                                    <div class="chartBox">
