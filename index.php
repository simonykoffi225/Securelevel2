                    ...
                    <div class="section_centrale">
                        <div class="formulaire">
                            <div class="text-inform">
                                <h3 class="text">Recensement Accident</h3>
                                <p class="text1"> Bienvenue Sur Ce Site Qui Vous Permettra De Recenser Tous Les Acidents De La Circulation</p>
                            </div>
                            <form action="connect_accidents.php" method="POST">
                                <div class="first">
                                    <div class="titre">
                                        <fieldset>
                                            <legend>Titre</legend>
                                ...
                                <div class="place">
                                    <div class="typeaccidents">
                                        <fieldset>
                                            <legend>Type Accident </legend>
                                            <select name="engins" id="engins">
                                                <option value=""></option>
                                                <?php foreach ($acci as $typeaccidents) : ?>
                                                    <option value="<?= $typeaccidents->id ?>"><?= $typeaccidents->typeaccidents ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="nombre">
                                        <div class="nbrenfant">
                                            <fieldset>
                                                ...
                                                <input type="text" name="nbrenfants" id="nbrenfants" class="form-control" oninput="handleInput()" placeholder="nombre d'enfant" required>
                                            </fieldset>
                                        </div>
                                        <div class="nbrdfemme">
                                            <fieldset>
                                                <legend>nombre de femme </legend>
                                                <input type="text" class="form-control" id="nbrfemmes" name="nbrfemmes" oninput="handleInput()" placeholder="nombre de femme" required>
                                            </fieldset>
                                        </div>
                                    </div>
                                    <div class="field">
                                ...
                                <button name="submit" id="bouton" type="submit" disabled>Enregistrement</button>
                        </div>
