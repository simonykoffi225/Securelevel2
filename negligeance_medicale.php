                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div class="text-inform">
                                <h3 class="text">Recensement Negligence Medical</h3>
                                <p class="text1"> Bienvenue Sur Ce Site Qui Vous Permettra De Recenser Tous Les Négligence Médical</p>
                            </div>
                            <form action="connect_négligence_medical.php" method="POST">
                                <div class="first">
                                    <div class="titre">
                                        <fieldset>
                                            <legend>Titre</legend>
                                ...
                                <div class="place">
                                    <div class="engin">
                                        <fieldset>
                                            <legend>type de Négligence Médical</legend>
                                            <select name="type" id="type">
                                                <option value=""></option>
                                                <?php foreach ($accidde as $typenegligences) : ?>
                                                    <option value="<?= $typenegligences->id ?>"><?= $typenegligences->typenegligences ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </fieldset>
                                    </div>
